...
class PromotePawn {
  ...
  initChoices() {
    ...
    [promoteToRook, promoteToKnight, promoteToBishop, promoteToQueen]
    .forEach(el => icons.appendChild(el));
  ...
  promote() {
    ...
    icons.forEach(figure => {
      figure.addEventListener("click", switchFigures)
    });
